export default {
	...
	paths: [
		{
			d: 'M18.563 11.063h-5.625V5.436a.938.938 0 00-1.876 0v5.625H5.439a.938.938 0 000 1.876h5.625v5.624a.938.938 0 001.874 0v-5.625h5.626a.938.938 0 000-1.874z',
			attrs: {
				fill: '#0094FF',
			},
		},
