export default {
	...
	paths: [
		{
			d: 'M15.5 13.5a4 4 0 10-4-4H7l1.5 6h8l.8-2.425a4 4 0 01-5.518-2.098A4.001 4.001 0 0015.5 13.5zm-3.982-3.621zM10 17.5a1 1 0 11-2 0 1 1 0 012 0zm6.5 0a1 1 0 11-2 0 1 1 0 012 0z',
			attrs: {
				fillRule: 'evenodd',
				clipRule: 'evenodd',
				fill: '#0094FF',
