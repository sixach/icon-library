export default {
	...
	paths: [
		...
		{
			d: 'M6.5 8.75V16a.75.75 0 01-.75.75h-.5A.75.75 0 014.5 16V5.75H9v1h7v2H6.5zm5.75 8a2.475 2.475 0 01-.5-1.5 2.5 2.5 0 012.225-2.475A2.5 2.5 0 0014 16.75h-1.75z',
			attrs: {
				fillRule: 'evenodd',
				clipRule: 'evenodd',
				fill: '#FFF',
