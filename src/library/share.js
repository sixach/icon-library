export default {
	...
	paths: [
		...
		{
			d: 'M4.754 10.25a2.5 2.5 0 01.075-.6 2.5 2.5 0 104.1 2.45 2.5 2.5 0 01-4.175-1.85zM16.504 9a2.5 2.5 0 002.425-1.9 2.5 2.5 0 01-4.1-2.45A2.5 2.5 0 0016.504 9zm-1.75 6.25c.001-.202.026-.404.075-.6a2.5 2.5 0 104.1 2.45 2.5 2.5 0 01-4.175-1.85z',
			attrs: {
				fill: '#FFF',
				opacity: '.25',
			},
