...
export default {
	...
	paths: [
		{
			d:
				'M3.25 3.25h17.5v5H3.25v-5zm0 7.5h17.5v3.75H3.25v-3.75zM5.75 17c-.69 0-1.25.56-1.25 1.25v2.5c0 .69.56 1.25 1.25 1.25h12.5c.69 0 1.25-.56 1.25-1.25v-2.5c0-.69-.56-1.25-1.25-1.25H5.75z',
			attrs: {
				fillRule: 'evenodd',
				clipRule: 'evenodd',
